#ifndef DCPFA_CONTROLLER_H
#define DCPFA_CONTROLLER_H
...
class DCPFA_controller : public BaseController {
	...
	public:
		...
		bool IsInTheNest();
		void DecayAndPrunePheromoneMemory(argos::Real current_time);
		std::vector<DecentralizedPheromone> ExportActivePheromones() const;
		size_t ReceivePheromones(const std::vector<DecentralizedPheromone>& pheromones);
		size_t GetPheromoneMemorySize() const;
		void SetPheromoneMemoryLimit(size_t max_pheromones);

		Real FoodDistanceTolerance;

		void SetLoopFunctions(DCPFA_loop_functions* lf);
