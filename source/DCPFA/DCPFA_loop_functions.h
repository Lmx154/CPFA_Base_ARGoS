#ifndef DCPFA_LOOP_FUNCTIONS_H
#define DCPFA_LOOP_FUNCTIONS_H
...
class DCPFA_loop_functions : public argos::CLoopFunctions
{

	friend class DCPFA_controller;
	friend class DCPFA_qt_user_functions;

	public:

		DCPFA_loop_functions();
		...
		void DecentralizedCommunicationStep();
	...
	protected:
		...
		size_t EnableDecentralizedSharing;
		argos::Real CommunicationRadius;
		argos::Real CommunicationRadiusSquared;
